    ...
    <Layout>
      ...
      <div
        ...
        <div
          ...
          <img src="/shopLogo.png" height={32} />
        </div>
        ...
        <ToggleButtonGroup
          ...
          <ToggleButton value="shirt" aria-label="centered">
            Top garments
          </ToggleButton>
          <ToggleButton value="pants" aria-label="right aligned">
            Bottom garments
          </ToggleButton>
        </ToggleButtonGroup>
        <div
          ...
          {userSizes && (
            <Button
              ...
              <img width={64} src="/logoBig.png" style={{ marginBottom: 3 }} />
            </Button>
          )}
        </div>
      </div>
      <main>
        ...
        <GridList list={finalList} userSizes={siz3rFilter && userSizes} />
      </main>
    </Layout>
  );
}
